#ifndef __LYOS__GUI__WINDOW_H
#define __LYOS__GUI__WINDOW_H
...
class Window : public CompositeWidget
{
  ...
  public:
    Window(Widget *parent, common::int32_t x, common::int32_t y, common::int32_t w,
           common::int32_t h, common::uint8_t r, common::uint8_t g, common::uint8_t b);
    ~Window();
